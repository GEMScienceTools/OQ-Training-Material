...
\begin{itemize}
    \item the four main source types used by OpenQuake 
    \item the main calculation workflows supported by Openquake: classical 
        PSHA, stochastic event based PSHA and scenario hazard.
\end{itemize}
\end{myfancybox}
    \input{intro_oq.tex}
% -----------------------------------------------------------------------------
